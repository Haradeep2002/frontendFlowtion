...
const Displayflow = (props) => {
    ...
    const goBack = () => (
        <div  style={{marginLeft:'50%'}}>
            {/* <br></br> */}
            <Link to="/" className="text-white" style={{ border: '2px solid black', backgroundColor: 'black', color: '#001233', textDecoration: 'none', padding: '10px' }}>
                Back to Home
            </Link>
        </div>
    );
...
const reload = () => (
        <div  style={{marginLeft:'50%'}}>
            {/* <br></br> */}
            <button className="text-white" style={{ border: '2px solid black', backgroundColor: 'black', color: '#001233', textDecoration: 'none', padding: '10px' }} onClick={refreshPage}>Wanna try again?</button>
        </div>)
    return (<div  style={{ backgroundColor: 'rgba(5,0,255,0.4)',height:'1000px' 
