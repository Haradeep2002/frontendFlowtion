            ...
            <div style={{ backgroundColor: 'rgba(5, 0, 255, 0.4)' }}>
                ...
                <br></br> */}
                    {!flag && isAuthenticated() && isAuthenticated().user.role === 0 && 
                        <img src={img} height="500px" width="100%" style={{marginBottom:'40px'}}></img>
                    }

                    {
                        
                        !flag && isAuthenticated() && isAuthenticated().user.role === 0 && 
                        <h1 style={{ marginLeft: '20%', color: 'black' ,fontWeight:'bolder'}}>
                    ...
                    <div style={{ display: 'flex' ,flexWrap: 'wrap',marginLeft:'80px'}}>
                        {
                            ...
                            categories && categories.map((fc, i) => {
                                return (<div style={{marginRight:'50px',marginLeft:'50px',marginTop:'8px'}} key={i}><div >
